...
public class Task_5 {
    public static void main(String[] args) {
        String text = "Антон купил ароматный арбуз и спелый ананас. Apple and avocado are tasty.";
        ...
        try {
            ...
            // Убираем пробелы по краям строки и извлекаем самый первый символ
            ...
            // Компилируем регулярное выражение с флагом поддержки Юникода и создаем поисковик Matcher для текста
